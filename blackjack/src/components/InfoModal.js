        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header bg-primary text-white">
              <h5 className="modal-title mx-auto fw-bolder" id="infoModalLabel">
                Game Rules and Button Explanations
              </h5>
            </div>
            <div className="modal-body bg-light text-dark">
              ...
              <ul>
                <li>
                  The points earned in this game are purely fictional, have no monetary value, and are for entertainment purposes only. They cannot be exchanged for any goods
                  or services.
                </li>
              ...
              <ul>
                ...
                <li>
                  <strong>Split Button</strong>: Split two cards of the same value into two separate hands, doubling your wager. Splitting is allowed if the game is in
                  progress, you haven't already split three times, the two cards have the same point value, and you have enough points for the wager.
                </li>
                <li>
                  <strong>Double Down Button</strong>: Double your initial wager and receive one more card. This is typically used when the odds are in your favor. Doubling
                  down is allowed if the game is in progress, your hand has exactly two cards, the total of the hand is 21 or less, and you have enough points for the wager.
                </li>
                <li>
                  <strong>Stand Button</strong>: Choose not to take any more cards and pass to the next hand or dealer. If the `standSwitch` is checked and your total is 21,
                  the game will automatically move to the dealer's turn or next hand.
                </li>
                <li>
